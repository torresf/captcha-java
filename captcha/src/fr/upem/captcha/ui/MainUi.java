...
public class MainUi {
	...
	private static JButton createQuitButton() {
		return new JButton(new AbstractAction("Quit") { // Ajouter l'action du bouton
			...
			public void actionPerformed(ActionEvent arg0) {
				EventQueue.invokeLater(new Runnable() { // Faire des choses dans l'interface donc appeler cela dans la queue des évÃ¨nements
	...
	private static JLabel createLabelImage(URL imageLocation) throws IOException{
		...
		label.addMouseListener(new MouseListener() { // Ajouter le listener d'évÃ¨nement de souris
